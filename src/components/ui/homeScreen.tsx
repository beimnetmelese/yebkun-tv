...
export default function HomePage(): ReactElement {
      ...
      <div className="flex-1 flex flex-col gap-4 p-2">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-transparent bg-opacity-50 transition-opacity duration-300">
          <div className="flex bg-white p-6 rounded-lg shadow-lg gap-6">
            {/* Left Side - Image */}
            <div className="w-1/4">
              <Image src="/images/image.png" alt="Popup Image" width={280} height={200} className="rounded-lg" />
            </div>
            
            {/* Right Side - Content */}
            <div className="w-3/4 flex flex-col items-center">
              <Image src="/images/download.png" alt="Popup Logo" width={200} height={150} className="mb-4" />
          ...
          <Image src="/images/apple.png" alt="QR App Store" width={50} height={50} className="rounded-lg" />
        ...
        <div className="py-4">
          <Image src="/images/logo.png" alt="Before Play Store" width={120} height={100} className="rounded-lg" />
        </div>
        <Image src="/images/qrcode.png" alt="After Play Store" width={150} height={100} className="rounded-lg" /></div>
                <div className="bg-gray-100 p-4 rounded-lg"><button className="bg-black text-white px-4 py-2 rounded-lg flex items-center justify-center gap-3 w-auto">
          <Image src="/images/googleplay.png" alt="QR Play Store" width={50} height={50} className="rounded-lg" />
          <div className="flex flex-col text-left">
  ...
  <div className="absolute inset-0 flex items-center justify-center bg-transparent bg-opacity-50 transition-opacity duration-300">
    <div className="flex gap-6">
      <div className="bg-white mr-6 rounded-lg shadow-lg flex flex-col items-center">
        <Image src="/images/kids.png" alt="Popup 1" width={300} height={150} className="rounded-lg" />
      ...
      <div className="bg-white ml-6 rounded-lg shadow-lg flex flex-col items-center">
        <Image src="/images/adults.png" alt="Popup 2" width={300} height={150} className="rounded-lg" />
  ...
  Start Now
      ...
      <div className="w-full md:w-1/4 flex flex-col items-center gap-4 px-2 py-4 border-l border-gray-300">
        ...
        <Image src="/images/qrcode.png" alt="After Play Store" width={150} height={100} className="rounded-lg" />
        {/* Google Play Button */}
        <button className="bg-black text-white px-4 py-2 rounded-lg flex items-center justify-center gap-3 w-auto">
          <Image src="/images/googleplay.png" alt="QR Play Store" width={50} height={50} className="rounded-lg" />
          <div className="flex flex-col text-left">
        ...
        <Image src="/images/qrcode.png" alt="After Play Store" width={150} height={100} className="rounded-lg" />
        <div className="py-4">
          <Image src="/images/conn.png" alt="After Play Store" width={150} height={100} className="rounded-lg" />
        </div>
      </div>
