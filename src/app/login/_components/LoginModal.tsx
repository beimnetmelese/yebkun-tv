  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="border-none button-none flex items-center justify-center p-[0px] m-[0px] bg-transparent border-[none] [&>button]:hidden">
        ...
        {firstPopup && (
          // First Popup - Download App
          <div className="flex bg-[#FFFFFF] p-[44px] rounded-[25px] shadow-lg gap-[58px] relative">
            {/* Background Pattern */}
            <Image
        ...
        {secondPopup && (
          // Second Popup - Device ID
          <div className="bg-[#FFFFFF] p-[32px] rounded-[25px] shadow-lg flex flex-col items-center w-[375px]">
